...
class AppContainer extends Component {
    ...
    clickedSearch(){
        ...
        var finalURL = `https://www.googleapis.com/youtube/v3/search?key=${API}&part=snippet,id&order=relevance&type=video&videoDuration=medium&maxResults=${result}&q=${filterText}`
        fetch(finalURL)
        ...
        <div className="appContainer row flex-xl-nowrap">
            <header className='col-12'>
                ...
                <div className="searchArea">
                    ...
                    <button onClick={this.clickedSearch}><i class="fas fa-search"></i></button>
                </div>
            </header>
